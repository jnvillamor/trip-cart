...
export default function CategoriesListScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: tokens.bg.page }}>
      <SegmentedHeader active="categories" tokens={tokens} />
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        <Text style={{ color: tokens.text.primary }}>Categories list</Text>
        <Text style={{ color: tokens.text.tertiary, marginTop: 8 }}>Phase 2A.3</Text>
      </View>
    </View>
  );
}
