 ...
 */
export function toMinorUnits(amount: number | null | undefined, code: string): number | null {
...
export function parseMoneyToMinorUnits(input: string, code: string): number | null {
